...
def p_mientrasq_instr(t) :
    'mientrasq_instr     : MIENTRASQ PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER'
    t[0] =Mientrasq(t[3], t[6])

def p_si_instr(t) :
    'si_instr           : SI PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER'
    t[0] =Si(t[3], t[6])

def p_si_sino_instr(t) :
    'si_sino_instr      : SI PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER SINO LLAVIZQ instrucciones LLAVDER'
    t[0] =SiSino(t[3], t[6], t[10])
