...
_lr_productions = [
  ...
  ('init -> instrucciones','init',1,'p_init','LexAPar.py',117),
  ('instrucciones -> instrucciones instruccion','instrucciones',2,'p_instrucciones_lista','LexAPar.py',121),
  ('instrucciones -> instruccion','instrucciones',1,'p_instrucciones_instruccion','LexAPar.py',127),
  ('instruccion -> imprimir_instr','instruccion',1,'p_instruccion','LexAPar.py',131),
  ('instruccion -> definicion_instr','instruccion',1,'p_instruccion','LexAPar.py',132),
  ('instruccion -> asignacion_instr','instruccion',1,'p_instruccion','LexAPar.py',133),
  ('instruccion -> mientrasq_instr','instruccion',1,'p_instruccion','LexAPar.py',134),
  ('instruccion -> si_instr','instruccion',1,'p_instruccion','LexAPar.py',135),
  ('instruccion -> si_sino_instr','instruccion',1,'p_instruccion','LexAPar.py',136),
  ('imprimir_instr -> IMPRIMIR PARIZQ expresion_cadena PARDER PTCOMA','imprimir_instr',5,'p_instruccion_imprimir','LexAPar.py',140),
  ('definicion_instr -> NUMERO ID PTCOMA','definicion_instr',3,'p_instruccion_definicion','LexAPar.py',144),
  ('asignacion_instr -> ID IGUAL expresion_numerica PTCOMA','asignacion_instr',4,'p_asignacion_instr','LexAPar.py',148),
  ('mientrasq_instr -> MIENTRASQ PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER','mientrasq_instr',7,'p_mientrasq_instr','LexAPar.py',152),
  ('si_instr -> SI PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER','si_instr',7,'p_si_instr','LexAPar.py',156),
  ('si_sino_instr -> SI PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER SINO LLAVIZQ instrucciones LLAVDER','si_sino_instr',11,'p_si_sino_instr','LexAPar.py',160),
  ('expresion_numerica -> expresion_numerica MAS expresion_numerica','expresion_numerica',3,'p_expresion_binaria','LexAPar.py',164),
  ('expresion_numerica -> expresion_numerica MENOS expresion_numerica','expresion_numerica',3,'p_expresion_binaria','LexAPar.py',165),
  ('expresion_numerica -> expresion_numerica POR expresion_numerica','expresion_numerica',3,'p_expresion_binaria','LexAPar.py',166),
  ('expresion_numerica -> expresion_numerica DIVIDIDO expresion_numerica','expresion_numerica',3,'p_expresion_binaria','LexAPar.py',167),
  ('expresion_numerica -> MENOS expresion_numerica','expresion_numerica',2,'p_expresion_unaria','LexAPar.py',174),
  ('expresion_numerica -> PARIZQ expresion_numerica PARDER','expresion_numerica',3,'p_expresion_agrupacion','LexAPar.py',178),
  ('expresion_numerica -> ENTERO','expresion_numerica',1,'p_expresion_number','LexAPar.py',182),
  ('expresion_numerica -> DECIMAL','expresion_numerica',1,'p_expresion_number','LexAPar.py',183),
  ('expresion_numerica -> ID','expresion_numerica',1,'p_expresion_id','LexAPar.py',187),
  ('expresion_cadena -> expresion_cadena CONCAT expresion_cadena','expresion_cadena',3,'p_expresion_concatenacion','LexAPar.py',191),
  ('expresion_cadena -> CADENA','expresion_cadena',1,'p_expresion_cadena','LexAPar.py',195),
  ('expresion_cadena -> expresion_numerica','expresion_cadena',1,'p_expresion_cadena_numerico','LexAPar.py',199),
  ('expresion_logica -> expresion_numerica MAYQUE expresion_numerica','expresion_logica',3,'p_expresion_logica','LexAPar.py',203),
  ('expresion_logica -> expresion_numerica MENQUE expresion_numerica','expresion_logica',3,'p_expresion_logica','LexAPar.py',204),
  ('expresion_logica -> expresion_numerica IGUALQUE expresion_numerica','expresion_logica',3,'p_expresion_logica','LexAPar.py',205),
  ('expresion_logica -> expresion_numerica NIGUALQUE expresion_numerica','expresion_logica',3,'p_expresion_logica','LexAPar.py',206),
]
